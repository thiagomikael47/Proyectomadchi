            ...
            this.DOM.svg.innerHTML = `
                ...
                <linearGradient id="gradient1" x1="0%" y1="0%" x2="0%" y2="100%">
                    <stop offset="0%" stop-color="#F20000 ">
                        <!--animate attributeName="stop-color" values="#F20000 ; #FFEDBC; #F20000" dur="3s" repeatCount="indefinite"></animate-->
                    </stop>
                    <stop offset="100%" stop-color="#FFEDBC">
                        <!--animate attributeName="stop-color" values="#FFEDBC; #F20000 ; #FFEDBC" dur="3s" repeatCount="indefinite"></animate-->
                    </stop>
                </linearGradient>
                </defs>
